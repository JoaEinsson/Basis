...
export const commands = {
	...
	playerSetMuted: (muted: boolean) => typedError<PlayerSnapshot, string>(__TAURI_INVOKE("player_set_muted", { muted })),
	playerClearUpcoming: () => typedError<PlayerSnapshot, string>(__TAURI_INVOKE("player_clear_upcoming")),
